...
namespace TMDBService
{
    public class TMDBServiceImpl : ITMDBService
    {
        ...
        public Dictionary<int, Genre> ShowGenres => _showGenres;

        public Dictionary<int, Genre> MovieGenres => _movieGenres;
        ...
        public async Task InitializeAsync()
        {
            ...
            try
            {
                ...
                TMDBGenresResponse showGenres = await _tmdbApiClient.GetShowGenresAsync(_apiKey);
                ...
                TMDBGenresResponse movieGenres = await _tmdbApiClient.GetMovieGenresAsync(_apiKey);
        ...
        public async Task<List<ListItem>> GetTrendingShowsAndMoviesAsync(int pageCount = 1)
        {
            ...
            if (_trendingShowsAndMovies.Count == 0)
            {
                try
                {
                    ...
                    {
                        TMDBListResponse<TMDBTrendingShowResponse> trendingShows = await _tmdbApiClient.GetTrendingShowsAsync(_apiKey, page: page);
                        TMDBListResponse<TMDBTrendingMovieResponse> trendingMovies = await _tmdbApiClient.GetTrendingMoviesAsync(_apiKey, page: page);
        ...
        public async Task<List<ListItem>> GetComedyShowsAndMoviesAsync(int pageCount = 1)
        {
            Debug.Assert(_isInitialized);
                ...
                try
                {
                    for (int page = 1; page <= pageCount; page++)
                    {
                        TMDBListResponse<TMDBDiscoverableShowResponse> comedyShows =
                            await _tmdbApiClient.GetDiscoverableShowsByGenresAsync(_apiKey, $"{SHOWS_COMEDY_GENRE_ID}", page: page);

                        TMDBListResponse<TMDBDiscoverableMovieResponse> comedyMovies =
                            await _tmdbApiClient.GetDiscoverableMoviesByGenresAsync(_apiKey, $"{MOVIES_COMEDY_GENRE_ID}", page: page);
        ...
        public async Task<List<ListItem>> GetActionAndAdventureShowsAndMoviesAsync(int pageCount = 1)
        {
            Debug.Assert(_isInitialized);
                ...
                try
                {
                    for (int page = 1; page <= pageCount; page++)
                    {
                        TMDBListResponse<TMDBDiscoverableShowResponse> actionAdventureShows =
                            await _tmdbApiClient.GetDiscoverableShowsByGenresAsync(_apiKey, $"{SHOWS_ACTION_ADVENTURE_GENRE_ID}", page: page);

                        TMDBListResponse<TMDBDiscoverableMovieResponse> actionAdventureMovies =
                            await _tmdbApiClient.GetDiscoverableMoviesByGenresAsync(_apiKey, $"{MOVIES_ACTION_GENRE_ID},{MOVIES_ADVENTURE_GENRE_ID}", page: page);
        ...
        public async Task<List<ListItem>> GetDramaShowsAndMoviesAsync(int pageCount = 1)
        {
            Debug.Assert(_isInitialized);
                ...
                try
                {
                    for (int page = 1; page <= pageCount; page++)
                    {
                        TMDBListResponse<TMDBDiscoverableShowResponse> dramaShows =
                            await _tmdbApiClient.GetDiscoverableShowsByGenresAsync(_apiKey, $"{SHOWS_DRAMA_GENRE_ID}", page: page);

                        TMDBListResponse<TMDBDiscoverableMovieResponse> dramaMovies =
                            await _tmdbApiClient.GetDiscoverableMoviesByGenresAsync(_apiKey, $"{MOVIES_DRAMA_GENRE_ID}", page: page);
        ...
        public async Task<List<ListItem>> GetAnimationShowsAndMoviesAsync(int pageCount = 1)
        {
            Debug.Assert(_isInitialized);
                ...
                try
                {
                    for (int page = 1; page <= pageCount; page++)
                    {
                        TMDBListResponse<TMDBDiscoverableShowResponse> animationShows =
                            await _tmdbApiClient.GetDiscoverableShowsByGenresAsync(_apiKey, $"{SHOWS_ANIMATION_GENRE_ID}", page: page);

                        TMDBListResponse<TMDBDiscoverableMovieResponse> animationMovies =
                            await _tmdbApiClient.GetDiscoverableMoviesByGenresAsync(_apiKey, $"{MOVIES_ANIMATION_GENRE_ID}", page: page);
        ...
        public async Task<List<ListItem>> GetScifiShowsAndMoviesAsync(int pageCount = 1)
        {
            Debug.Assert(_isInitialized);
                ...
                try
                {
                    for (int page = 1; page <= pageCount; page++)
                    {
                        TMDBListResponse<TMDBDiscoverableShowResponse> scifiShows =
                            await _tmdbApiClient.GetDiscoverableShowsByGenresAsync(_apiKey, $"{SHOWS_SCIFI_GENRE_ID}", page: page);

                        TMDBListResponse<TMDBDiscoverableMovieResponse> scifiMovies =
                            await _tmdbApiClient.GetDiscoverableMoviesByGenresAsync(_apiKey, $"{MOVIES_SCIFI_GENRE_ID}", page: page);
        ...
        public async Task<List<ListItem>> GetCrimeShowsAndMoviesAsync(int pageCount = 1)
        {
            Debug.Assert(_isInitialized);
                ...
                try
                {
                    for (int page = 1; page <= pageCount; page++)
                    {
                        TMDBListResponse<TMDBDiscoverableShowResponse> crimeShows =
                            await _tmdbApiClient.GetDiscoverableShowsByGenresAsync(_apiKey, $"{SHOWS_CRIME_GENRE_ID}", page: page);

                        TMDBListResponse<TMDBDiscoverableMovieResponse> crimeMovies =
                            await _tmdbApiClient.GetDiscoverableMoviesByGenresAsync(_apiKey, $"{MOVIES_CRIME_GENRE_ID}", page: page);
        ...
        public async Task<List<ListItem>> GetMysteryShowsAndMoviesAsync(int pageCount = 1)
        {
            Debug.Assert(_isInitialized);
                ...
                try
                {
                    for (int page = 1; page <= pageCount; page++)
                    {
                        TMDBListResponse<TMDBDiscoverableShowResponse> mysteryShows =
                            await _tmdbApiClient.GetDiscoverableShowsByGenresAsync(_apiKey, $"{SHOWS_MYSTERY_GENRE_ID}", page: page);

                        TMDBListResponse<TMDBDiscoverableMovieResponse> mysteryMovies =
                            await _tmdbApiClient.GetDiscoverableMoviesByGenresAsync(_apiKey, $"{MOVIES_MYSTERY_GENRE_ID}", page: page);
        ...
        public async Task<List<ListItem>> GetThrillerShowsAndMoviesAsync(int pageCount = 1)
        {
            Debug.Assert(_isInitialized);
                ...
                try
                {
                    for (int page = 1; page <= pageCount; page++)
                    {
                        TMDBListResponse<TMDBDiscoverableShowResponse> thrillerShows =
                            await _tmdbApiClient.GetDiscoverableShowsByKeywordsAsync(_apiKey, $"{THRILLER_KEYWORD_ID}", page: page);

                        TMDBListResponse<TMDBDiscoverableMovieResponse> thrillerMovies =
                            await _tmdbApiClient.GetDiscoverableMoviesByGenresAsync(_apiKey, $"{MOVIES_THRILLER_GENRE_ID}", page: page);
        ...
        public async Task<List<ListItem>> GetHorrorShowsAndMoviesAsync(int pageCount = 1)
        {
            Debug.Assert(_isInitialized);
                ...
                try
                {
                    for (int page = 1; page <= pageCount; page++)
                    {
                        TMDBListResponse<TMDBDiscoverableShowResponse> horrorShows =
                            await _tmdbApiClient.GetDiscoverableShowsByKeywordsAsync(_apiKey, $"{HORROR_KEYWORD_ID}", page: page);

                        TMDBListResponse<TMDBDiscoverableMovieResponse> horrorMovies =
                            await _tmdbApiClient.GetDiscoverableMoviesByGenresAsync(_apiKey, $"{MOVIES_HORROR_GENRE_ID}", page: page);
        ...
        public async Task<List<ListItem>> GetFamilyShowsAndMoviesAsync(int pageCount = 1)
        {
            Debug.Assert(_isInitialized);
                ...
                try
                {
                    for (int page = 1; page <= pageCount; page++)
                    {
                        TMDBListResponse<TMDBDiscoverableShowResponse> familyShows =
                            await _tmdbApiClient.GetDiscoverableShowsByGenresAsync(_apiKey, $"{SHOWS_FAMILY_GENRE_ID}", page: page);

                        TMDBListResponse<TMDBDiscoverableMovieResponse> familyMovies =
                            await _tmdbApiClient.GetDiscoverableMoviesByGenresAsync(_apiKey, $"{MOVIES_FAMILY_GENRE_ID}", page: page);
        ...
        public async Task<List<ListItem>> GetKidsShowsAndMoviesAsync(int pageCount = 1)
        {
            Debug.Assert(_isInitialized);
                ...
                try
                {
                    for (int page = 1; page <= pageCount; page++)
                    {
                        TMDBListResponse<TMDBDiscoverableShowResponse> kidsShows =
                            await _tmdbApiClient.GetDiscoverableShowsByGenresAsync(_apiKey, $"{SHOWS_KIDS_GENRE_ID}", page: page);

                        TMDBListResponse<TMDBDiscoverableMovieResponse> kidsMovies =
                            await _tmdbApiClient.GetDiscoverableMoviesByKeywordsAsync(_apiKey, $"{KIDS_KEYWORD_ID}", page: page);
        ...
        public async Task<List<ListItem>> GetFantasyMoviesAsync(int pageCount = 1)
        {
            Debug.Assert(_isInitialized);
                ...
                try
                {
                    for (int page = 1; page <= pageCount; page++)
                    {
                        TMDBListResponse<TMDBDiscoverableMovieResponse> fantasyMovies =
                            await _tmdbApiClient.GetDiscoverableMoviesByGenresAsync(_apiKey, $"{MOVIES_FANTASY_GENRE_ID}", page: page);
        ...
        public async Task<List<ListItem>> GetWesternShowsAndMoviesAsync(int pageCount = 1)
        {
            Debug.Assert(_isInitialized);
                ...
                try
                {
                    for (int page = 1; page <= pageCount; page++)
                    {
                        TMDBListResponse<TMDBDiscoverableShowResponse> westernShows =
                            await _tmdbApiClient.GetDiscoverableShowsByGenresAsync(_apiKey, $"{SHOWS_WESTERN_GENRE_ID}", page: page);

                        TMDBListResponse<TMDBDiscoverableMovieResponse> westernMovies =
                            await _tmdbApiClient.GetDiscoverableMoviesByGenresAsync(_apiKey, $"{MOVIES_WESTERN_GENRE_ID}", page: page);
        ...
        public async Task<List<ListItem>> GetHistoryShowsAndMoviesAsync(int pageCount = 1)
        {
            Debug.Assert(_isInitialized);
                ...
                try
                {
                    for (int page = 1; page <= pageCount; page++)
                    {
                        TMDBListResponse<TMDBDiscoverableShowResponse> historyShows =
                            await _tmdbApiClient.GetDiscoverableShowsByKeywordsAsync(_apiKey, $"{HISTORY_KEYWORD_ID}", page: page);

                        TMDBListResponse<TMDBDiscoverableMovieResponse> historyMovies =
                            await _tmdbApiClient.GetDiscoverableMoviesByGenresAsync(_apiKey, $"{MOVIES_HISTORY_GENRE_ID}", page: page);
        ...
        public async Task<List<ListItem>> GetRomanceShowsAndMoviesAsync(int pageCount = 1)
        {
            Debug.Assert(_isInitialized);
                ...
                try
                {
                    for (int page = 1; page <= pageCount; page++)
                    {
                        TMDBListResponse<TMDBDiscoverableShowResponse> romanceShows =
                            await _tmdbApiClient.GetDiscoverableShowsByKeywordsAsync(_apiKey, $"{ROMANCE_KEYWORD_ID}", page: page);

                        TMDBListResponse<TMDBDiscoverableMovieResponse> romanceMovies =
                            await _tmdbApiClient.GetDiscoverableMoviesByGenresAsync(_apiKey, $"{MOVIES_ROMANCE_GENRE_ID}", page: page);
        ...
        public async Task<List<ListItem>> GetWarShowsAndMoviesAsync(int pageCount = 1)
        {
            Debug.Assert(_isInitialized);
                ...
                try
                {
                    for (int page = 1; page <= pageCount; page++)
                    {
                        TMDBListResponse<TMDBDiscoverableShowResponse> warShows =
                            await _tmdbApiClient.GetDiscoverableShowsByGenresAsync(_apiKey, $"{SHOWS_WAR_GENRE_ID}", page: page);

                        TMDBListResponse<TMDBDiscoverableMovieResponse> warMovies =
                            await _tmdbApiClient.GetDiscoverableMoviesByGenresAsync(_apiKey, $"{MOVIES_WAR_GENRE_ID}", page: page);
        ...
        public async Task<List<ListItem>> GetDocumentaryShowsAndMovies(int pageCount = 1)
        {
            Debug.Assert(_isInitialized);
                ...
                try
                {
                    for (int page = 1; page <= pageCount; page++)
                    {
                        TMDBListResponse<TMDBDiscoverableShowResponse> documentaryShows =
                            await _tmdbApiClient.GetDiscoverableShowsByGenresAsync(_apiKey, $"{SHOWS_DOCUMENTARY_GENRE_ID}", page: page);

                        TMDBListResponse<TMDBDiscoverableMovieResponse> documentaryMovies =
                            await _tmdbApiClient.GetDiscoverableMoviesByGenresAsync(_apiKey, $"{MOVIES_DOCUMENTARY_GENRE_ID}", page: page);
        ...
        public async Task<List<ListItem>> GetSitcomShowsAsync(int pageCount = 1)
        {
            Debug.Assert(_isInitialized);
                ...
                try
                {
                    for (int page = 1; page <= pageCount; page++)
                    {
                        TMDBListResponse<TMDBDiscoverableShowResponse> sitcomShows =
                            await _tmdbApiClient.GetDiscoverableShowsByKeywordsAsync(_apiKey, $"{SITCOM_KEYWORD_ID}", page: page);
        ...
        public async Task<List<ListItem>> GetAnthologyShowsAsync(int pageCount = 1)
        {
            Debug.Assert(_isInitialized);
                ...
                try
                {
                    for (int page = 1; page <= pageCount; page++)
                    {
                        TMDBListResponse<TMDBDiscoverableShowResponse> anthologyShows =
                            await _tmdbApiClient.GetDiscoverableShowsByKeywordsAsync(_apiKey, $"{ANTHOLOGY_KEYWORD_ID}", page: page);
        ...
        public async Task<List<ListItem>> GetAnimeShowsAndMoviesAsync(int pageCount = 1)
        {
            Debug.Assert(_isInitialized);
                ...
                try
                {
                    for (int page = 1; page <= pageCount; page++)
                    {
                        TMDBListResponse<TMDBDiscoverableShowResponse> animeShows =
                            await _tmdbApiClient.GetDiscoverableShowsByKeywordsAsync(_apiKey, $"{ANIME_KEYOWRD_ID}", page: page);

                        TMDBListResponse<TMDBDiscoverableMovieResponse> animeMovies =
                            await _tmdbApiClient.GetDiscoverableMoviesByKeywordsAsync(_apiKey, $"{ANIME_KEYOWRD_ID}", page: page);
        ...
        public async Task<List<ListItem>> GetTeenDramaShowsAndMoviesAsync(int pageCount = 1)
        {
            Debug.Assert(_isInitialized);
                ...
                try
                {
                    for (int page = 1; page <= pageCount; page++)
                    {
                        TMDBListResponse<TMDBDiscoverableShowResponse> teenDramaShows =
                            await _tmdbApiClient.GetDiscoverableShowsByKeywordsAsync(_apiKey, $"{TEEN_DRAMA_KEYWORD_ID}", page: page);

                        TMDBListResponse<TMDBDiscoverableMovieResponse> teenDramaMovies =
                            await _tmdbApiClient.GetDiscoverableMoviesByKeywordsAsync(_apiKey, $"{TEEN_DRAMA_KEYWORD_ID}", page: page);
        ...
        public async Task<List<ListItem>> GetHistoricalDramaShowsAndMovies(int pageCount = 1)
        {
            Debug.Assert(_isInitialized);
                ...
                try
                {
                    for (int page = 1; page <= pageCount; page++)
                    {
                        TMDBListResponse<TMDBDiscoverableShowResponse> historicalDramaShows =
                            await _tmdbApiClient.GetDiscoverableShowsByKeywordsAsync(_apiKey, $"{HISTORICAL_DRAMA_KEYWORD_ID}", page: page);

                        TMDBListResponse<TMDBDiscoverableMovieResponse> historicalDramaMovies =
                            await _tmdbApiClient.GetDiscoverableMoviesByKeywordsAsync(_apiKey, $"{HISTORICAL_DRAMA_KEYWORD_ID}", page: page);
        ...
        public async Task<List<ListItem>> GetWorkplaceComedyShowsAndMovies(int pageCount = 1)
        {
            Debug.Assert(_isInitialized);
                ...
                try
                {
                    for (int page = 1; page <= pageCount; page++)
                    {
                        TMDBListResponse<TMDBDiscoverableShowResponse> workplaceComedyShows =
                            await _tmdbApiClient.GetDiscoverableShowsByKeywordsAsync(_apiKey, $"{WORKPLACE_COMEDY_KEYWORD_ID}", page: page);

                        TMDBListResponse<TMDBDiscoverableMovieResponse> workplaceComedyMovies =
                            await _tmdbApiClient.GetDiscoverableMoviesByKeywordsAsync(_apiKey, $"{WORKPLACE_COMEDY_KEYWORD_ID}", page: page);
        ...
        public async Task<List<ListItem>> GetMedicalDramaShowsAndMovies(int pageCount = 1)
        {
            Debug.Assert(_isInitialized);
                ...
                try
                {
                    for (int page = 1; page <= pageCount; page++)
                    {
                        TMDBListResponse<TMDBDiscoverableShowResponse> medicalDramaShows =
                            await _tmdbApiClient.GetDiscoverableShowsByKeywordsAsync(_apiKey, $"{MEDICAL_DRAMA_KEYWORD_ID}", page: page);

                        TMDBListResponse<TMDBDiscoverableMovieResponse> medicalDramaMovies =
                            await _tmdbApiClient.GetDiscoverableMoviesByKeywordsAsync(_apiKey, $"{MEDICAL_DRAMA_KEYWORD_ID}", page: page);
